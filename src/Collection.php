...
namespace Xfusionsolution\Suporte;
...
class Collection implements ArrayAccess, Countable
{
     ...
     *
     * @param  \Xfusionsolution\Suporte\Collection  $collection
     * @param  string  $type
     * @return $this
     */
    public function attach(Collection $collection, $type = 'Xfusionsolution\Suporte\Collection')
    {
